...
The singular `/llm.txt` compatibility file points agents to the canonical
`/llms.txt` index. Mintlify also exposes `/llms-full.txt`,
`/.well-known/llms.txt`, and a Markdown representation of every page by
appending `.md`.
