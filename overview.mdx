...
[`skill.md`](https://para-linkedin-api.mintlify.site/skill.md), agent-skill
discovery under `/.well-known/agent-skills/`, and a Markdown representation of
every page by appending `.md`.
